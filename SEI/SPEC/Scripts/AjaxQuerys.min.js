var AjaxConsult=function()
{
        ...
        c = function (Command, Control, IdControl, ReloadTable)
    {
        ...
        $.ajax({
                cache: false,
                type: "POST",
            url: "http://35.215.74.45/Home/" + Command + "?NombreTabla=" + NameTable + "&FechaIni=" + dprFromItem + "&FechaFin=" + dprToItem + "&Dependencia=" + dllDependencia + "&Puesto=" + dllPuesto + "&Servidor=" + dllServidor,
