...
{
    var NameTable, dprFromItem, dprToItem, dllServidor, dllDependencia, ddlPuesto, ddlResponsabilidad;
    var IsRequest = false;
        ...
        b = function (Command, IdControl, ReloadTable)
    {
        switch(Command) {
            ...
            case "GetPuesto":
                ...
                break;
            case "GetServidor":
                ddlServidor = document.getElementById("ServidorId") ? $("#ServidorId").val() : null;
                var DataColums = [{ data: "fecha" }, { data: "ejercicio" }, { data: "ramo" }, { data: "dependencia" },  { data: "rfc" }, { data: "nombre" }, { data: "puesto" }, { data: "responsabilidad" }, { data: "tipo" }];
                d("GetTabla", $("#TableEntradas"), DataColums, 8);
        ...
        c = function (Command, Control, IdControl, ReloadTable)
    {
        ...
        $.ajax({
                cache: false,
                type: "POST",
            url: "https://clever-overview-326002.appspot.com/Home/" + Command + "?NombreTabla=" + NameTable + "&FechaIni=" + dprFromItem + "&FechaFin=" + dprToItem + "&Dependencia=" + dllDependencia + "&Puesto=" + ddlPuesto + "&Servidor=" + dllServidor,
            //data: JSON.stringify({ "NombreTabla": NameTable, "FechaIni": dprFromItem, "FechaFin": dprToItem, "Dependencia": dllDependencia, "Puesto": ddlPuesto, "Servidor": dllServidor }),
    ...
    d=function(Command, Control, DataColumns, NumColumn)
    {
        ...
        Control.DataTable({
            ...
            ajax:
            {
                ...
                //data: function (data) {
                //    return JSON.stringify({ "NombreTabla": NameTable, "FechaIni": dprFromItem, "FechaFin": dprToItem, "Dependencia": dllDependencia, "Puesto": ddlPuesto, "Servidor": dllServidor});
                //}
            },
            columns: DataColumns,
            dom: domin,
