  ...
  var t,
    ...
    f = function () {
      $("body").on(
        ...
        function (t) {
          ...
          $("body").hasClass("page-portlet-fullscreen") &&
          ...
          function (t) {
            ...
            if (e.hasClass("portlet-fullscreen"))
              ...
              var o =
                ...
                parseInt(e.children(".portlet-body").css("padding-top")) -
                parseInt(e.children(".portlet-body").css("padding-bottom"));
              $(this).addClass("on"),
                  ...
                  error: function (t, o, i) {
                    ...
                    "toastr" == a && toastr
                      ...
                      ? ($.notific8("zindex", 11500),
                        $.notific8(n, { theme: "ruby", life: 3e3 }))
                      : alert(n);
                  },
                }))
              : (App.blockUI({ target: e, animate: !0, overlayColor: "none" }),
    ...
    g = function () {
      $().iCheck &&
        $(".icheck").each(function () {
          var t = $(this).attr("data-checkbox")
              ? $(this).attr("data-checkbox")
              : "icheckbox_minimal-grey",
            e = $(this).attr("data-radio")
    ...
    x = function () {
      $("body").on("hide.bs.modal", function () {
        ...
        $("html").hasClass("modal-open") === !1
          ? $("html").addClass("modal-open")
          : $(".modal:visible").size() <= 1 &&
            $("html").removeClass("modal-open");
      }),
        $("body").on("show.bs.modal", ".modal", function () {
          $(this).hasClass("modal-scroll") &&
      ...
      $().slimScroll &&
        $(t).each(function () {
          if ("1" === $(this).attr("data-initialized")) {
            ...
            var t = {};
            $(this).attr("data-handle-color") &&
              (t["data-handle-color"] = $(this).attr("data-handle-color")),
              $(this).attr("data-wrapper-class") &&
                (t["data-wrapper-class"] = $(this).attr("data-wrapper-class")),
              $(this).attr("data-rail-color") &&
                (t["data-rail-color"] = $(this).attr("data-rail-color")),
              $(this).attr("data-always-visible") &&
                (t["data-always-visible"] = $(this).attr(
                  "data-always-visible"
                )),
              $(this).attr("data-rail-visible") &&
                (t["data-rail-visible"] = $(this).attr("data-rail-visible")),
              $(this).slimScroll({
                wrapperClass: $(this).attr("data-wrapper-class")
                  ? $(this).attr("data-wrapper-class")
                  : "slimScrollDiv",
