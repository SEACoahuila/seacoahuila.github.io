...
{
    var NameTable, dprFromItem, dprToItem, ddlUnidadMedica, ddlAlmacen, ddlProveedor, ddlContrato, ddlClave;
    var IsRequest = false;
    ...
    var a=function(IdControl, ReloadTable)
    {
        ...
        {
            IsRequest = true;
            if (document.getElementById("UnidadMedicaId") && (IdControl == "dpRange"))
            {
                $("#UnidadMedicaId").select2("val", "");
            }

            if (document.getElementById("ProveedorId") && ((IdControl == "dpRange") || (IdControl == "UnidadMedicaId") || (IdControl == "AlmacenId")))
            {
                $("#ProveedorId").select2("val", "");
            }
            if (document.getElementById("ContratoId") && ((IdControl == "dpRange") || (IdControl == "UnidadMedicaId") || (IdControl == "AlmacenId") || (IdControl == "ProveedorId")))
            {
                $("#ContratoId").select2("val", "");
            }
            if (document.getElementById("ClaveId") && ((IdControl == "dpRange") || (IdControl == "UnidadMedicaId") || (IdControl == "AlmacenId") || (IdControl == "ProveedorId") || (IdControl == "ContratoId")))
            {
                $("#ClaveId").select2("val", "");
            }
        ...
        b = function (Command, IdControl, ReloadTable)
    {
        switch(Command) {
            case "Initialize":
                if (document.getElementById("UnidadMedicaId") && ((IdControl == "dpRange")))
                {
                    c("GetUnidadMedica", $("#UnidadMedicaId"), IdControl, ReloadTable);
                }
                else
                {
                    b("GetUnidadMedica", IdControl, ReloadTable);
                }
                break;
            case "GetUnidadMedica":
                ddlUnidadMedica = document.getElementById("UnidadMedicaId") ? $("#UnidadMedicaId").val() : null;
                if (document.getElementById("AlmacenId") && ((IdControl == "dpRange") || (IdControl == "UnidadMedicaId")))
                {
                    c("GetAlmacen", $("#AlmacenId"), IdControl, ReloadTable);
                }
                else
                {
                    b("GetAlmacen", IdControl, ReloadTable);
                }
                break;
            case "GetAlmacen":
                ddlAlmacen = document.getElementById("AlmacenId") ? $("#AlmacenId").val() : null;
                if (document.getElementById("ProveedorId") && ((IdControl == "dpRange") || (IdControl == "UnidadMedicaId"))) {
                    c("GetProveedor", $("#ProveedorId"), IdControl, ReloadTable);
                }
                else {
                    b("GetProveedor", IdControl, ReloadTable);
                }
                break;
            case "GetProveedor":
                ddlProveedor = document.getElementById("ProveedorId") ? $("#ProveedorId").val() : null;
                if ((NameTable == 'FRP') || (NameTable == 'FRDET') || (NameTable == 'FRPED') || (NameTable == 'consumos') || (NameTable == 'entradas') || (NameTable == 'existencias'))
                {
                   
                    if (document.getElementById("ContratoId") && ((IdControl == "dpRange") || (IdControl == "UnidadMedicaId") || (IdControl == "AlmacenId") || (IdControl == "ProveedorId"))) {
                        c("GetContrato", $("#ContratoId"), IdControl, ReloadTable);
                    }
                    else {
                        b("GetContrato", IdControl, ReloadTable);
                    }
            ...
            else
                {
                    ...
                    if (document.getElementById("ClaveId") && ((IdControl == "dpRange") || (IdControl == "UnidadMedicaId") || (IdControl == "AlmacenId") || (IdControl == "ProveedorId") || (IdControl == "ContratoId"))) {
                        c("GetClave", $("#ClaveId"), IdControl, ReloadTable);
                    }
                    else {
                        b("GetClave", IdControl, ReloadTable);
                    }
                }
                break;
            case "GetContrato":
                ddlContrato = $("#ContratoId").val();
                if (document.getElementById("ClaveId") && ((IdControl == "dpRange") || (IdControl == "UnidadMedicaId") || (IdControl == "AlmacenId") || (IdControl == "ProveedorId") || (IdControl == "ContratoId")))
                {
                    c("GetClave", $("#ClaveId"), IdControl, ReloadTable);
                }
                ...
                break;
            case "GetClave":
                ddlClave = $("#ClaveId").val();
                if (ReloadTable == 1) {
                    switch (NameTable) {
                        case "entradas":
                            var DataColums = [{ data: "Fecha" }, { data: "Almacen" }, { data: "Factura" }, { data: "Clave" }, { data: "Lote" }, { data: "Descripcion" }, { data: "Proveedor" }, { data: "Contrato" }, { data: "Cantidad" }, { data: "Monto" }];
                            d("GetTabla", $("#TableEntradas"), DataColums, 9);
                            break;
                        case "consumos":
                            var DataColums = [{ data: "Unidad" }, { data: "Clave" }, { data: "Descripcion" }, { data: "Proveedor" }, { data: "Contrato" }, { data: "Cantidad" }];
                            d("GetTabla", $("#TableConsumos"), DataColums, 5);
                            break;
                        case "surtidos":
                            var DataColums = [{ data: "Fecha" }, { data: "Almacen" }, { data: "Unidad" }, { data: "Clave" }, { data: "CantSolicitada" }, { data: "CantRecibida" }, { data: "Observacion" }];
                            d("GetTabla", $("#TableSurtidos"), DataColums, 6);
                            break;
                        case "existencias":
                            var DataColums = [{ data: "Fecha" }, { data: "Unidad" }, { data: "Clave" }, { data: "Descripcion" }, { data: "Proveedor" }, { data: "Contrato" }, { data: "Cantidad" }];
                            d("GetTabla", $("#TableExistencias"), DataColums, 6);
                            break;
                        case "soluciones":
                            var DataColums = [{ data: "Fecha" }, { data: "Unidad" }, { data: "Clave" }, { data: "Descripcion" }, { data: "Proveedor" }, { data: "Contrato" }, { data: "Cantidad" }];
                            d("GetTabla", $("#TableSoluciones"), DataColums, 6);
                            break;
                        case "subrogacion":
                            var DataColums = [{ data: "Fecha" }, { data: "Unidad" }, { data: "Clave" }, { data: "Descripcion" }, { data: "Proveedor" }, { data: "Contrato" }, { data: "Cantidad" }];
                            d("GetTabla", $("#TableSubrogacion"), DataColums, 6);
                            break;
                        case "frp":
                            var DataColums = [{ data: "Origen" }, { data: "Almacen" }, { data: "Proveedor" }, { data: "CantidadPedidos" }, { data: "CantidadPedida" }, { data: "CantidadRecibida" }, { data: "Cumplimiento" }];
                            d("GetTabla", $("#TableFRP"), DataColums, 5);
                            break;
                        case "frped":
                            var DataColums = [{ data: "Origen" }, { data: "Almacen" }, { data: "Proveedor" }, { data: "Contrato" },
                            { data: "NoPedido" }, { data: "FechaPedido" },
                            { data: "ClavesPed" }, { data: "ClavesRec" }, { data: "Cumplimiento" },
                            { data: "CantidadPed" }, { data: "CantidadRec" }, { data: "Porcentaje" }];
                            d("GetTabla", $("#TableFRPED"), DataColums, 10);
                            break;
                        case "frdet":
                            var DataColums = [{ data: "Origen" }, { data: "Almacen" }, { data: "Proveedor" }, { data: "NoPedido" }, { data: "Clave" },
                            { data: "Descripcion" }, { data: "FechaPed" },
                            { data: "CantidadPed" }, { data: "Cantidad" }, { data: "FechaEntr" }, { data: "DiasPen" }];
                            d("GetTabla", $("#TableFRDET"), DataColums, 9);
                            break;
                    }
                    break;
                }
        ...
        c = function (Command, Control, IdControl, ReloadTable)
    {
        ...
        $.ajax({
            ...
            data: JSON.stringify({ "NombreTabla": NameTable, "FechaIni": dprFromItem, "FechaFin": dprToItem, "UnidadMedica": ddlUnidadMedica, "Proveedor": ddlProveedor, "Contrato": ddlContrato, "Clave": ddlClave, "Almacen": ddlAlmacen }),
    ...
    d=function(Command, Control, DataColumns, NumColumn)
    {
        ...
        Control.DataTable({
            ...
            ajax:
            {
                ...
                dataSrc: "d",
                data: function (data) {
                    return JSON.stringify({ "NombreTabla": NameTable, "FechaIni": dprFromItem, "FechaFin": dprToItem, "UnidadMedica": ddlUnidadMedica, "Almacen": ddlAlmacen, "Proveedor": ddlProveedor, "Contrato": ddlContrato, "Clave": ddlClave });
                }
            },
            columns: DataColumns,
            dom: domin,
