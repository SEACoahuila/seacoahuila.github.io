...
{
    var NameTable, dprFromItem, dprToItem, ddlUnidadMedica, ddlPaciente, ddlMedico, ddlClave;
    var IsRequest = false;
    ...
    var a = function (IdControl, ReloadTable) {
        ...
        if (IsRequest == false) {
            ...
            //if (document.getElementById("PacienteId") && ((IdControl == "dpRange") || (IdControl == "UnidadMedicaId"))) {
            //    $("#PacienteId").select2("val", "");
                
            //}
            //if (document.getElementById("MedicoId") && ((IdControl == "dpRange") || (IdControl == "UnidadMedicaId") || (IdControl == "PacienteId"))) {
            //    $("#MedicoId").select2("val", "");
                
            //}
            if (document.getElementById("ClaveId") && ((IdControl == "dpRange") || (IdControl == "UnidadMedicaId") || (IdControl == "PacienteId") || (IdControl == "MedicoId"))) {
                $("#ClaveId").select2("val", "");
        ...
        switch (Command) {
            case "Initialize":
                if (document.getElementById("UnidadMedicaId") && ((IdControl == "dpRange"))) {
                    c("GetUnidadMedica1", $("#UnidadMedicaId"), IdControl, ReloadTable);
                }
                else {
                    b("GetUnidadMedica1", IdControl, ReloadTable);
                }
                break;
            //case "GetUnidadMedica1":
            //    ddlUnidadMedica = document.getElementById("UnidadMedicaId") ? $("#UnidadMedicaId").val() : null;
            //    if (document.getElementById("PacienteId") && ((IdControl == "dpRange") || (IdControl == "UnidadMedicaId"))) {
            //        c("GetPaciente1", $("#PacienteId"), IdControl, ReloadTable);
            //    }
            //    else {
            //        b("GetPaciente1", IdControl, ReloadTable);
            //    }
            //    break;
            //case "GetPaciente1":
            //    ddlPaciente = document.getElementById("PacienteId") ? $("#PacienteId").val() : null;
                
            //        if (document.getElementById("MedicoId") && ((IdControl == "dpRange") || (IdControl == "UnidadMedicaId") || (IdControl == "PacienteId"))) {
            //            c("GetMedico1", $("#MedicoId"), IdControl, ReloadTable);
            //        }
            //        else {
            //            b("GetMedico1", IdControl, ReloadTable);
            //        }
                
            //    break;
            case "GetUnidadMedica1":
                //ddlMedico = $("#MedicoId").val();
                ddlUnidadMedica = document.getElementById("UnidadMedicaId") ? $("#UnidadMedicaId").val() : null;
                if (document.getElementById("ClaveId") && ((IdControl == "dpRange") || (IdControl == "UnidadMedicaId") || (IdControl == "PacienteId") || (IdControl == "MedicoId"))) {
                    c("GetClave1", $("#ClaveId"), IdControl, ReloadTable);
                }
                else {
                    b("GetClave1", IdControl, ReloadTable);
                }
                break;
            case "GetClave1":
                ...
                if (ReloadTable == 1) {
                    switch (NameTable) {
                        case "recetas":
                            var DataColums = [{ data: "Fecha" }, { data: "Farmacia" }, { data: "CodPac" }, { data: "Paciente" }, { data: "Medico" }, { data: "Clave" }, { data: "Descripcion" }, { data: "Cantidad" }, { data: "Folio" }, { data: "Laboratorio" }];
                            d("GetTabla1", $("#TableRecetas"), DataColums, 9);
                            break;
                    }
                } else {
        ...
        $.ajax({
            ...
            data: JSON.stringify({ "NombreTabla": NameTable, "FechaIni": dprFromItem, "FechaFin": dprToItem, "UnidadMedica": ddlUnidadMedica, "Paciente": ddlPaciente, "Medico": ddlMedico, "Clave": ddlClave }),
    ...
    d = function (Command, Control, DataColumns, NumColumn) {
        ...
        Control.DataTable({
            ...
            ajax:
            {
                ...
                dataSrc: "d",
                data: function (data) {
                    return JSON.stringify({ "NombreTabla": NameTable, "FechaIni": dprFromItem, "FechaFin": dprToItem, "UnidadMedica": ddlUnidadMedica, "Paciente": ddlPaciente, "Medico": ddlMedico, "Clave": ddlClave });
                }
            },
            columns: DataColumns,
            dom: domin,
            ...
            { extend: "copy", className: "btn red btn-outline" },
                {
                    extend: "pdf", className: "btn green btn-outline", orientation: 'landscape', pageSize: 'LEGAL', customize: function (doc) {
    ...
    return { init: function () { a("dpRange"), Funct() } }
}();
App.isAngularJsApp() === !1 && jQuery(document).ready(function () { Recetas.init() });